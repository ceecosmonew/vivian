...
{/*         <p className='fw-bold'>My Social Media Handles:</p> */}
        <p>
          ...
          <a href="https://facebook.com/profile.php?id=61567123451884" target="_blank" rel="noreferrer" className="text-white mx-2"><i className='fa-brands fa-facebook fa-2x text-info'></i></a>
